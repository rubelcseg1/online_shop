                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="message-center">
                                            ...
                                            <!-- Message -->
                                            <a href="index.html#">
                                                <div class="user-img"> <img src="{{asset('contents/admin')}}/assets/images/users/3.jpg" alt="user" class="img-circle"> <span class="profile-status away pull-right"></span> </div>
                                                <div class="mail-contnet">
                                        ...
                                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container"> <img class="d-block img-fluid" src="{{asset('contents/admin')}}/assets/images/big/img1.jpg" alt="First slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="{{asset('contents/admin')}}/assets/images/big/img2.jpg" alt="Second slide"></div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container"><img class="d-block img-fluid" src="{{asset('contents/admin')}}/assets/images/big/img3.jpg" alt="Third slide"></div>
                                                </div>
                                            </div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        @if(Auth::user()->role=='1')
                        <li> <a class=" waves-effect waves-dark" href="index.html#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">User </span></a></li>
                        @endif
                        @if(Auth::user()->role=='1' || Auth::user()->role=='2')
                        <li> <a class=" waves-effect waves-dark" href="index.html#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Banner </span></a></li>
                        @endif
                        <li> <a class=" waves-effect waves-dark" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Log out </span></a>
                                                      <form id="logout-form" action="{{ route('logout') }}" method="POST" class="d-none">
                                        @csrf
                                    </form>
                          
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="index.html#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Manage <span class="label label-rouded label-themecolor pull-right">4</span></span></a>
